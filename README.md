...
SQL allows us to create, update, or delete information within databases. 

2. Why do tables need a `primary key`?

Tables need a primary key to ensure each row is accessible and unique to prevent errors
